...
public class IOoperations {
    ...
    /**
     * Prints the elements of a HashSet in one line without a line break.
     * @param set
     */
     ...
     * @param set
     */
    public static String convertHashSetLabelLanguageTupleToStringPipeSeparated(HashSet<LabelLanguageTuple> set){
        String result = "";
        for(LabelLanguageTuple s : set){
